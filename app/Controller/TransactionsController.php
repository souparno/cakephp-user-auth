 ...
 */
	public function view($id = null) {
		...
		$this->set('transaction', $this->Transaction->find('first', $options));
                ...
                $results=$this->Transaction->query("Select products.image1_small,subcategories.title,transactiondetails.quantity,transactiondetails.price from transactions join transactiondetails on transactions.id=transactiondetails.transaction_id join products on products.id =transactiondetails.product_id join subcategories on products.subcategory_id=subcategories.id where transactions.id='".$id."'");
